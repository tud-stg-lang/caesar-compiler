...
Caesar requires parser and scanner source files to be generated before the rest can be compiled.
This is done by calling the ant on default target defined in the build.xml
...
Please use the scripts defined in scripts directory to invoke the compiler.
...
BCEL - Those portions of this distribution in the org.apache Java namespace 
are available under the terms of the GNU Lesser General Public 
