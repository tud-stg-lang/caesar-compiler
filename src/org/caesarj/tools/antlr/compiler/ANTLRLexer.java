...
public class ANTLRLexer extends org.caesarj.tools.antlr.runtime.CharScanner implements ANTLRTokenTypes, TokenStream
 {
...
public ANTLRLexer(LexerSharedInputState state) {
	...
	literals.put(new ANTLRHashString("exception", this), new Integer(34));
	literals.put(new ANTLRHashString("class", this), new Integer(9));
	literals.put(new ANTLRHashString("public", this), new Integer(27));
	literals.put(new ANTLRHashString("header", this), new Integer(5));
	literals.put(new ANTLRHashString("options", this), new Integer(46));
	literals.put(new ANTLRHashString("charVocabulary", this), new Integer(16));
	literals.put(new ANTLRHashString("tokens", this), new Integer(4));
	literals.put(new ANTLRHashString("returns", this), new Integer(30));
	literals.put(new ANTLRHashString("private", this), new Integer(28));
	literals.put(new ANTLRHashString("protected", this), new Integer(26));
	literals.put(new ANTLRHashString("throws", this), new Integer(32));
