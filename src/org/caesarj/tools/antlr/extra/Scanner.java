 ...
 *
 * $Id: Scanner.java,v 1.1 2004-02-08 16:47:55 ostermann Exp $
 */
...
public abstract class Scanner implements TokenStream {
   ...
   */
  protected Scanner(CompilerBase compiler, InputBuffer buffer) {
  ...
  public final Token nextToken() {
	...
	reportTrouble(Messages.IO_EXCEPTION, new Object[]{ buffer.getFile(), e.getMessage()});
      }
    }
  }
  ...
  public final TokenReference getTokenReference() {
    return TokenReference.build(buffer.getFile(), buffer.getPath(), buffer.getLine());
  }
