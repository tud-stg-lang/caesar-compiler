...
public class LargeTests extends TestCase {	
	...
	public void testWeaving() throws Throwable {			
		Log.setVerbose(true);
		FileOutputStream fos = new FileOutputStream("large-tests/weavingtest.log");
		...
		String args[] = {
			"-d", "large-tests/weavingtest/bin", 
			"-v", "-classpath",
			"dist/caesar-runtime.jar;large-tests/weavingtest/lib/base.jar", 
			"-inpath",
	...
	public void testTwomoreBottomUp() throws Throwable {			
		Log.setVerbose(true);
		FileOutputStream fos = new FileOutputStream("large-tests/twomore-bottomup.log");
		...
		String args[] = {
			"-d", "large-tests/twomore-bottomup-bin", 
			"-v", "-classpath",
