 ...
 *
 * $Id: CClassContext.java,v 1.2 2003-08-11 22:44:15 werner Exp $
 */
...
public class CClassContext extends CContext {
  ...
  protected CClassContext(CContext parent, KjcEnvironment environment, CSourceClass clazz, JTypeDeclaration decl) {
  // andreas end
