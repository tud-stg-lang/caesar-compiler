 ...
 *
 * $Id: CSourceClass.java,v 1.1 2004-02-08 16:47:45 ostermann Exp $
 */
...
public class CSourceClass extends CClass {
  ...
  public CType[] genConstructorArray(CType[] params) {
	...
	while (enum.hasMoreElements()) {
	  result[pos++] = ((JLocalVariable)enum.nextElement()).getType();
	}
      }
   ...
   * @param	optimizer	the bytecode optimizer to use
   */
  protected MethodInfo[] genMethods(BytecodeOptimizer optimizer, TypeFactory factory)
