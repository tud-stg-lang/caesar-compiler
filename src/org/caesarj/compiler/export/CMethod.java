 ...
 *
 * $Id: CMethod.java,v 1.1 2004-02-08 16:47:45 ostermann Exp $
 */
...
/*    if (!isPostcondition()) {
  ...
  public void setThrowables(Hashtable throwables) {
	...
	exceptions[count++] = ((CThrowableInfo)enum.nextElement()).getThrowable();
      }
    }
  }
  ...
  public CSourceMethod getAccessor(TypeFactory factory, CSourceClass target, boolean isSuper) {
