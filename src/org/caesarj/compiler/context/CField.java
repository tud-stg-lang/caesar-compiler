 ...
 *
 * $Id: CField.java,v 1.1 2004-02-08 16:47:38 ostermann Exp $
 */
...
import org.caesarj.compiler.ast.JAccessorMethod;
...
//     throw new InconsistencyException("accesability depends on primary - use 'isAccessible(primary, from)'");
//   }
  ...
  public CMethod getAccessor(TypeFactory typeFactory, 
                      CSourceClass target, 
                      boolean leftSide, 
                      boolean isSuper, 
                      int oper) {
    if (leftSide) {
      ...
      if (accessorSet == null) {
        JAccessorMethod accessor = new JAccessorMethod(typeFactory, 
                                                       target, 
                                                       this, 
                                                       leftSide, 
                                                       isSuper, 
