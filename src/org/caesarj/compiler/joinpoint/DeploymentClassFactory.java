...
import org.caesarj.compiler.ast.phylum.declaration.DeploymentSupportClassDeclaration;
...
import org.caesarj.compiler.ast.phylum.expression.FjCastExpression;
...
import org.caesarj.compiler.ast.phylum.expression.FjUnqualifiedInstanceCreation;
...
public class DeploymentClassFactory implements CaesarConstants {
	...
	public void modifyAspectClass() {
		...
		FjFieldDeclaration	field = new FjFieldDeclaration(where, var, true, null, null);
		field.setGenerated();
	...
	public JClassDeclaration createSingletonAspect() {
		...
		field = new FjFieldDeclaration(where, aspectInstanceVar, true, null, null);
		field.setGenerated();
		fields.add(field);
	...
	private JClassDeclaration createAroundClosure(AdviceDeclaration advice) {
		...
		var =
			new JVariableDefinition(
				...
				new JNullLiteral(where));
		field = new FjFieldDeclaration(where, var, true, null, null);
		field.setGenerated();
		fields.add(field);
