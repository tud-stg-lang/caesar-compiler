 ...
 *
 * $Id: CompilerBase.java,v 1.1 2004-02-18 09:23:42 klose Exp $
 */
...
public abstract class CompilerBase {
   ...
   */
  protected CompilerBase(String workingDirectory,
  ...
  public File[] verifyFiles(String[] names) throws UnpositionedError {
	...
	try {
	  ...
	  throw new UnpositionedError(Messages.INVALID_LIST_FILE,
	...
	if (!file.exists() || !file.isAbsolute()) {
	  throw new UnpositionedError(Messages.FILE_NOT_FOUND, temp.elementAt(i), null);
	}
      }
      files[i] = file;
    }
  ...
  private void readLine(Vector list, String filename, String line)  throws UnpositionedError {
    ...
    while (lineChars.length > index) {
      ...
      case '\'':
        ...
        if (lineChars[index] != '\'') {
          // missing end '
          throw new UnpositionedError(Messages.INVALID_LIST_FILE, filename , line);
        } else {
