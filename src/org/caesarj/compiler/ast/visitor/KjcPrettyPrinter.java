 ...
 *
 * $Id: KjcPrettyPrinter.java,v 1.1 2004-03-15 11:56:53 aracic Exp $
 */
 ...
 */
public class KjcPrettyPrinter extends org.caesarj.util.Utils implements Constants, KjcVisitor {
  ...
  public void visitJavadoc(JavadocComment comment)
 {
	...
	if (param) {
	  ...
	  */
	  String	_before = text.substring(0, idx);
	  // Andreas end
	  print(" * " + type);
	  pos += 12;
	  /* Andreas start
