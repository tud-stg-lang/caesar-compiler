	...
	extends FjConstants
{
	...
	protected final static String REGEX_BASE_METHOD = 
		"((" + SEPERATOR + ")*" +
		"(" + SELFCONTEXT_METHOD_SUFFIX + ")*" +
		"(" + IMPLEMENTATION_METHOD_SUFFIX + ")*)".intern();
	...
	public static final CReferenceType WRAPPER_KEY_TYPE = 
		new CClassNameType("org/caesarj/runtime/WrapperKey".intern());
