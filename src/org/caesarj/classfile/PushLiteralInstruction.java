 ...
 *
 * $Id: PushLiteralInstruction.java,v 1.1 2003-07-05 18:29:37 werner Exp $
 */
...
public class PushLiteralInstruction extends Instruction {
   ...
   */
  /*package*/ void write(ConstantPool cp, DataOutput out) throws ClassFileFormatException, IOException {
  ...
  interface Operand {
     ...
     * @exception	java.io.IOException	an io problem has occured
     */
    void write(ConstantPool cp, DataOutput out) throws ClassFileFormatException, IOException;
  }
