 ...
 * 
 * $Id: Attribute.java,v 1.8 2005-01-24 16:52:57 aracic Exp $
 */
...
public abstract class Attribute {
	...
	public static Attribute read(DataInput in, ConstantPool cp)
		...
		AsciiConstant name = (AsciiConstant) cp.getEntryAt(in
				.readUnsignedShort());
			...
			case 'L' :
				if (tag.equals("LineNumberTable")) {
					throw new ClassFileFormatException(
							"Attribute \"LineNumberTable\" illegal outside of Attribute Code");
	...
	public static Attribute readCodeInfoAttribute(DataInput in,
			ConstantPool cp, Instruction[] insns) throws IOException,
		...
		switch (tag.charAt(0)) {
			case 'C' :
				if (tag.equals("Code")) {
					throw new ClassFileFormatException(
							"Attribute \"Code\" illegal as sub-attribute of Attribute Code");
				} else if (tag.equals("ConstantValue")) {
					throw new ClassFileFormatException(
							"Attribute \"ConstantValue\" illegal as sub-attribute of Attribute Code");
				}
				break;
			case 'D' :
				if (tag.equals("Deprecated")) {
					throw new ClassFileFormatException(
							"Attribute \"Deprecated\" illegal as sub-attribute of Attribute Code");
				}
				break;
			case 'E' :
				if (tag.equals("Exceptions")) {
					throw new ClassFileFormatException(
							"Attribute \"Exceptions\" illegal as sub-attribute of Attribute Code");
				}
				break;
			case 'I' :
				if (tag.equals("InnerClasses")) {
					throw new ClassFileFormatException(
							"Attribute \"InnerClasses\" illegal as sub-attribute of Attribute Code");
				}
				break;
			case 'L' :
				if (tag.equals("LineNumberTable")) {
			...
			case 'S' :
				if (tag.equals("SourceFile")) {
					throw new ClassFileFormatException(
							"Attribute \"SourceFile\" illegal as sub-attribute of Attribute Code");
				} else if (tag.equals("Synthetic")) {
					throw new ClassFileFormatException(
							"Attribute \"Synthetic\" illegal as sub-attribute of Attribute Code");
				}
				break;
			default :
				break;
	 ...
	 */
	/* package */protected abstract void resolveConstants(ConstantPool cp)
			throws ClassFileFormatException;
	/**
	 * Write this class into the the file (out) getting data position from the
	 * constant pool
	 * 
	 * @param cp
