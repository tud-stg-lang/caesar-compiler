 ...
 * 
 * $Id: ConstantPool.java,v 1.3 2005-01-24 16:52:57 aracic Exp $
 */
...
public class ConstantPool implements ClassfileConstants2 {
   ...
   */
  /*package*/ public final void addItem(PooledConstant item) throws ClassFileFormatException {
    PooledConstant old;
   ...
   * @exception	java.io.IOException	an io problem has occured
   */
  /*package*/ void write(DataOutput out) throws ClassFileFormatException, IOException {
